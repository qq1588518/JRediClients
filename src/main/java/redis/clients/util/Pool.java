...
public abstract class Pool<T> implements Closeable {
	...
	/**
	 * Using this constructor means you have to set and initialize the internalPool
	 * yourself.
	 */
	public Pool() {
	}
	 ...
	 *
	 * @return The number of instances currently borrowed from this pool, -1 if the
	 *         pool is inactive.
	 */
	 ...
	 *
	 * @return The number of instances currently idle in this pool, -1 if the pool
	 *         is inactive.
	 */
	...
	/**
	 * Returns an estimate of the number of threads currently blocked waiting for a
	 * resource from this pool.
	 *
	...
	/**
	 * Returns the mean waiting time spent by threads to obtain a resource from this
	 * pool.
	 *
