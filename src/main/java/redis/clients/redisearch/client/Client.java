...
import java.util.*;
import redis.clients.redisearch.Query;
import redis.clients.redisearch.Schema;
import redis.clients.redisearch.SearchResult;
...
public class Client {
    ...
    public boolean createIndex(Schema schema, IndexOptions options) {
        ...
        boolean ret = conn.getClient().sendCommand(commands.getCreateCommand(), args.toArray(new String[args.size()]));
        String res = conn.getClient().getStatusCodeReply();
        conn.close();
    ...
    public SearchResult search(Query q) {
        ...
        Jedis conn = _conn();
        boolean ret = conn.getClient().sendCommand(commands.getSearchCommand(), args.toArray(new byte[args.size()][]));
        List<Object> res = conn.getClient().getObjectMultiBulkReply();
        conn.close();
        return new SearchResult(res, !q.getNoContent(), q.getWithScores(), q.getWithPayloads());
    }
    ...
    public boolean addDocument(String docId, double score, Map<String, Object> fields, boolean noSave, boolean replace, byte[] payload) {
        ...
        boolean ret= conn.getClient().sendCommand(commands.getAddCommand(),
    ...
    public boolean addHash(String docId, double score, boolean replace) {
        ...
        Jedis conn = _conn();
        boolean ret = conn.getClient().sendCommand(commands.getAddHashCommand(),
    ...
    public Map<String, Object> getInfo() {
        ...
        Jedis conn = _conn();
        boolean ret = conn.getClient().sendCommand(commands.getInfoCommand(), this.indexName);
		List<Object> res = conn.getClient().getObjectMultiBulkReply();
        conn.close();
    ...
    public boolean deleteDocument(String docId) {
        ...
        Jedis conn = _conn();
        boolean ret = conn.getClient().sendCommand(commands.getDelCommand(), this.indexName, docId);
        Long res = conn.getClient().getIntegerReply();
        conn.close();
        return res == 1;
    }
    ...
    public boolean dropIndex() {
        Jedis conn = _conn();
        boolean ret = conn.getClient().sendCommand(commands.getDropCommand(), this.indexName);
        String res = conn.getClient().getStatusCodeReply();
        conn.close();
        return res.equals("OK");
    }
    ...
    public long optimizeIndex() {
        Jedis conn = _conn();
        boolean ret = conn.getClient().sendCommand(commands.getOptimizeCommand(), this.indexName);
        Long res = conn.getClient().getIntegerReply();
        conn.close();
        return res;
    }
    ...
    public List<Object> broadcast(String... args) {
        ...
        Jedis conn = _conn();
        boolean ret = conn.getClient().sendCommand(commands.getBroadcastCommand(), this.indexName);
        List res = conn.getClient().getObjectMultiBulkReply();
        conn.close();
        return res;
    }
}
