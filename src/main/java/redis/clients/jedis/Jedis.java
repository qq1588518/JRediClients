...
public class Jedis extends BinaryJedis implements JedisCommands, MultiKeyCommands, AdvancedJedisCommands,
	...
	public Jedis(final String host, final int port, final int connectionTimeout, final int soTimeout,
			...
			final SSLParameters sslParameters, final HostnameVerifier hostnameVerifier) {
		super(host, port, connectionTimeout, soTimeout, password, database, ssl, sslSocketFactory, sslParameters,
				hostnameVerifier);
	}
	...
	public String sentinelFailover(String masterName) {
		...
		String reply = client.getStatusCodeReply();
		if (!"OK".equalsIgnoreCase(reply)) {
			logger.error("Send SENTINEL SENTINEL_FAILOVER Command Error! reply={}" , reply);
		}
		return reply;
	}
	...
	public String sentinelMonitor(String masterName, String ip, int port, int quorum) {
		...
		String reply = client.getStatusCodeReply();
		if (!"OK".equalsIgnoreCase(reply)) {
			logger.error("Send SENTINEL SENTINEL_MONITOR Command Error! reply={}" , reply);
		}
		return reply;
	}
	...
	public String sentinelRemove(String masterName) {
		...
		String reply = client.getStatusCodeReply();
		if (!"OK".equalsIgnoreCase(reply)) {
			logger.error("Send SENTINEL SENTINEL_REMOVE Command Error! reply={}" , reply);
		}
		return reply;
	}
	...
	public String sentinelSet(String masterName, Map<String, String> parameterMap) {
		...
		String reply = client.getStatusCodeReply();
		if (!"OK".equalsIgnoreCase(reply)) {
			logger.error("Send SENTINEL SENTINEL_SET Command Error! reply={}" , reply);
		}
		return reply;
	}
	...
	public String clientKill(final String clientkill) {
		checkIsInMultiOrPipeline();
	...
	public String clientSetname(final String name) {
		...
		String reply = client.getStatusCodeReply();
		if (!"OK".equalsIgnoreCase(reply)) {
			logger.error("Send CLIENT SETNAME Command Error! reply={}" , reply);
		}
		return reply;
	}
	...
	public String pfmerge(final String destkey, final String... sourcekeys) {
		...
		String reply = client.getStatusCodeReply();
		if (!"OK".equalsIgnoreCase(reply)) {
			logger.error("Send FMIGRATE Command Error! reply={}" , reply);
		}
		return reply;
	}
	...
	public String clusterNodes() {
		...
		if (!"OK".equalsIgnoreCase(reply)) {
			logger.error("Send CLUSTER CLUSTER_NODES Command Error! reply={}" , reply);
		}
		return reply;
	}
	...
	public String readonly() {
		...
		String reply = client.getStatusCodeReply();
		if (!"OK".equalsIgnoreCase(reply)) {
			logger.error("Send READONLY Command Error! reply={}" , reply);
		}
		return reply;
	}
	...
	public String clusterMeet(final String ip, final int port) {
		...
		String reply = client.getStatusCodeReply();
		if (!"OK".equalsIgnoreCase(reply)) {
			logger.error("Send CLUSTER CLUSTER_MEET Command Error! reply={}" , reply);
		}
		return reply;
	}
	...
	public String clusterAddSlots(final int... slots) {
		...
		String reply = client.getStatusCodeReply();
		if (!"OK".equalsIgnoreCase(reply)) {
			logger.error("Send CLUSTER CLUSTER_ADDSLOTS Command Error! reply={}" , reply);
		}
		return reply;
	}
	...
	public String clusterDelSlots(final int... slots) {
		...
		String reply = client.getStatusCodeReply();
		if (!"OK".equalsIgnoreCase(reply)) {
			logger.error("Send CLUSTER CLUSTER_DELSLOTS Command Error! reply={}" , reply);
		}
		return reply;
	}
	...
	public String clusterInfo() {
		...
		String reply = client.getStatusCodeReply();
		if (!"OK".equalsIgnoreCase(reply)) {
			logger.error("Send CLUSTER CLUSTER_INFO Command Error! reply={}" , reply);
		}
		return reply;
	}
	...
	public String clusterSetSlotNode(final int slot, final String nodeId) {
		...
		String reply = client.getStatusCodeReply();
		if (!"OK".equalsIgnoreCase(reply)) {
			logger.error("Send CLUSTER CLUSTER_SETSLOT Command Error! reply={}" , reply);
		}
		return reply;
	}
	...
	public String clusterForget(final String nodeId) {
		...
		String reply = client.getStatusCodeReply();
		if (!"OK".equalsIgnoreCase(reply)) {
			logger.error("Send CLUSTER CLUSTER_FORGET Command Error! reply={}" , reply);
		}
		return reply;
	}
	...
	public String clusterFlushSlots() {
		...
		String reply = client.getStatusCodeReply();
		if (!"OK".equalsIgnoreCase(reply)) {
			logger.error("Send CLUSTER CLUSTER_FLUSHSLOT Command Error! reply={}" , reply);
		}
		return reply;
	}
	...
	public String clusterSaveConfig() {
		...
		String reply = client.getStatusCodeReply();
		if (!"OK".equalsIgnoreCase(reply)) {
			logger.error("Send CLUSTER CLUSTER_SAVECONFIG Command Error! reply={}" , reply);
		}
		return reply;
	}
	...
	public String clusterReplicate(final String nodeId) {
		...
		String reply = client.getStatusCodeReply();
		if (!"OK".equalsIgnoreCase(reply)) {
			logger.error("Send CLUSTER CLUSTER_REPLICATE Command Error! reply={}" , reply);
		}
		return reply;
	}
	...
	public String clusterFailover() {
		...
		String reply = client.getStatusCodeReply();
		if (!"OK".equalsIgnoreCase(reply)) {
			logger.error("Send CLUSTER CLUSTER_FAILOVER Command Error! reply={}" , reply);
		}
		return reply;
	}
	...
	public String asking() {
		...
		String reply = client.getStatusCodeReply();
		if (!"OK".equalsIgnoreCase(reply)) {
			logger.error("Send ASKING Command Error! reply={}" , reply);
		}
		return reply;
	}
