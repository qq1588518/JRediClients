...
public class JedisShardInfo extends ShardInfo<Jedis> {
	...
	public JedisShardInfo(String host, int port, boolean ssl, SSLSocketFactory sslSocketFactory,
		...
		this(host, port, 2000, 2000, Sharded.DEFAULT_WEIGHT, ssl, sslSocketFactory, sslParameters, hostnameVerifier);
	}
	...
	public JedisShardInfo(String host, int port, int timeout, boolean ssl, SSLSocketFactory sslSocketFactory,
			SSLParameters sslParameters, HostnameVerifier hostnameVerifier) {
