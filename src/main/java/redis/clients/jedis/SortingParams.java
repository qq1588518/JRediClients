...
public class SortingParams {
	...
	/**
	 * Sort lexicographicaly. Note that Redis is utf-8 aware assuming you set the
	 * right value for the LC_COLLATE environment variable.
	 * 
	 * @return the SortingParams Object
	 */
	 ...
	 * <p>
	 * Takes a pattern that is used in order to generate the key names of the result
	 * of sorting. The key names are obtained substituting the first occurrence of *
