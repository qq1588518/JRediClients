...
import redis.clients.redisson.spring.misc.BeanMethodInvoker;
...
public class RedissonNamespaceParserSupport {
    ...
    static final String API_CLASS_PATH_PREFIX = "redis.clients.redisson.api.R";
    static final String IMPL_CLASS_PATH_PREFIX = "redis.clients.redisson.Redisson";
