...
import redis.clients.redisson.codec.DefaultCodecProvider;
...
import redis.clients.redisson.liveobject.provider.DefaultResolverProvider;
...
public class Config {
     ...
     *
     * @see redis.clients.redisson.client.codec.Codec
     * 
     * @param codec object
     * @return config
     */
     ...
     * @return config
     * @see redis.clients.redisson.codec.CodecProvider
     */
