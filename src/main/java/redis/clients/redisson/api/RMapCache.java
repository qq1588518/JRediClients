 ...
 * Expired tasks cleaned by {@link redis.clients.redisson.eviction.EvictionScheduler}. This scheduler
 * deletes expired entries in time interval between 5 seconds to 2 hours.</p>
 *
 * <p>If eviction is not required then it's better to use {@link redis.clients.redisson.RedissonMap}.</p>
 *
...
public interface RMapCache<K, V> extends RMap<K, V>, RMapCacheAsync<K, V> {
     ...
     * 
     * @see redis.clients.redisson.api.map.event.EntryCreatedListener
     * @see redis.clients.redisson.api.map.event.EntryUpdatedListener
     * @see redis.clients.redisson.api.map.event.EntryRemovedListener
     * @see redis.clients.redisson.api.map.event.EntryExpiredListener
     * 
