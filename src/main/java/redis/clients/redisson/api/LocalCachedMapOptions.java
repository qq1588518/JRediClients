...
import redis.clients.redisson.api.map.MapLoader;
import redis.clients.redisson.api.map.MapWriter;
...
public class LocalCachedMapOptions<K, V> extends MapOptions<K, V> {
    ...
    @Override
    public LocalCachedMapOptions<K, V> writeMode(redis.clients.redisson.api.MapOptions.WriteMode writeMode) {
