...
import redis.clients.redisson.api.map.event.EntryCreatedListener;
import redis.clients.redisson.api.map.event.EntryEvent;
import redis.clients.redisson.api.map.event.EntryExpiredListener;
import redis.clients.redisson.api.map.event.EntryRemovedListener;
import redis.clients.redisson.api.map.event.EntryUpdatedListener;
import redis.clients.redisson.api.map.event.MapEntryListener;
...
import redis.clients.redisson.client.protocol.convertor.NumberConvertor;
import redis.clients.redisson.client.protocol.decoder.ListMultiDecoder;
import redis.clients.redisson.client.protocol.decoder.LongMultiDecoder;
import redis.clients.redisson.client.protocol.decoder.MapCacheScanResult;
import redis.clients.redisson.client.protocol.decoder.MapCacheScanResultReplayDecoder;
import redis.clients.redisson.client.protocol.decoder.MapScanResult;
import redis.clients.redisson.client.protocol.decoder.ObjectListDecoder;
import redis.clients.redisson.client.protocol.decoder.ObjectMapDecoder;
import redis.clients.redisson.client.protocol.decoder.ScanObjectEntry;
import redis.clients.redisson.codec.MapCacheEventCodec;
import redis.clients.redisson.command.CommandAsyncExecutor;
import redis.clients.redisson.connection.decoder.MapGetAllDecoder;
 ...
 *
 * <p>If eviction is not required then it's better to use {@link redis.clients.redisson.RedissonMap} object.</p>
 *
