...
import redis.clients.redisson.RedissonMapCache;
 ...
 *
 * <p>If eviction is not required then it's better to use {@link redis.clients.redisson.reactive.RedissonMapReactive}.</p>
 *
